          ...
          <div className="space-y-6 lg:space-y-8 text-center lg:text-left">
            <div className="space-y-4 lg:space-y-6">
              <h1 className="text-white text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-foreground leading-tight">
                ...
                <span className="text-red-600">Sillas para Barberías</span> y
                Salones de Belleza
              </h1>
              <p className="text-white sm:text-lg lg:text-xl text-muted-foreground leading-relaxed max-w-lg mx-auto lg:mx-0">
                Especializados en restaurar y reformar sillas de barbero y salón
                de belleza. Devolvemos la comodidad y elegancia que sus clientes
                merecen.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
              ...
              <Button
                ...
                onClick={() =>
                  window.open(
                    "https://wa.me/34685572880?text=¡Hola! Me gustaría un presupuesto gratis para reforma de sillas de ChairFix. ¿Puede ayudarme?",
                    "_blank"
                  )
                }
              >
              ...
              <div className="absolute bottom-3 sm:bottom-4 left-3 sm:left-4 bg-white/95 backdrop-blur-sm rounded-lg px-3 sm:px-4 py-2 sm:py-3 shadow-lg">
                <div className="flex items-center space-x-2">
                  <div className="flex items-center">
                    ...
                    <span className="ml-1 text-sm sm:text-base font-bold text-foreground">
                      4.9/5
                    </span>
                  </div>
                ...
                <p className="text-xs sm:text-sm text-muted-foreground mt-1">
                  150+ Establecimientos Atendidos
                </p>
              </div>
            </div>
          </div>
