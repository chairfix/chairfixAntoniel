          ...
          <div className="bg-gray-200/30 backdrop-blur-sm rounded-2xl p-6 sm:p-8 max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <Button 
                size="lg" 
                variant="outline"
              className="w-full sm:w-auto border-2 bg-blue-600 cursor-pointer border-blue-600 text-white hover:bg-blue-700 hover:text-white px-6 sm:px-8 py-3 text-base sm:text-lg font-semibold rounded-lg shadow-lg transform transition-all hover:scale-105"
