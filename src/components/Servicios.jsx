      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 lg:mb-16">
          ...
          <p className="text-lg sm:text-xl text-white max-w-3xl mx-auto">
            Ofrecemos soluciones completas para mantener sus sillas siempre en
            perfecto estado, garantizando comodidad y profesionalismo.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="text-center group hover:transform hover:scale-105 transition-all duration-300">
            ...
            <h3 className="text-lg sm:text-xl font-bold text-white mb-3 lg:mb-4">
              Reforma de Tapicería
            </h3>
            <p className="text-sm sm:text-base text-white leading-relaxed">
              Cambio completo de tapicería con materiales de alta calidad,
          ...
          <div className="text-center group hover:transform hover:scale-105 transition-all duration-300">
            ...
            <p className="text-sm sm:text-base text-white leading-relaxed">
              Mantenimiento y cambio de sistemas hidráulicos para altura y
              reclinación perfectas.
            </p>
          </div>
          ...
          <div className="text-center group hover:transform hover:scale-105 transition-all duration-300">
            ...
            <p className="text-sm sm:text-base text-white leading-relaxed">
              Preservamos el encanto clásico de las sillas antiguas con técnicas
              especializadas.
            </p>
          </div>
          ...
          <div className="text-center group hover:transform hover:scale-105 transition-all duration-300">
            ...
            <p className="text-sm sm:text-base text-white leading-relaxed">
              Soldaduras, tornillos y refuerzos para garantizar máxima
          ...
          <div className="text-center group hover:transform hover:scale-105 transition-all duration-300">
            ...
            <p className="text-sm sm:text-base text-white leading-relaxed">
              Pintura profesional con pintura automotriz para resistir el uso
              intensivo.
            </p>
          </div>
          ...
          <div className="text-center group hover:transform hover:scale-105 transition-all duration-300">
            ...
            <p className="text-sm sm:text-base text-white leading-relaxed">
              Colores, logos y detalles personalizados para combinar con su
              marca.
            </p>
          </div>
        </div>
        ...
        <div className="text-center mt-12">
          <div className="bg-gradient-to-r from-accent/10 to-accent/20 rounded-2xl p-8 max-w-3xl mx-auto">
            ...
            <p className="text-white mb-6">
              No deje que las sillas rotas perjudiquen su negocio. ¡Solicite un
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Button
                ...
                onClick={() =>
                  window.open(
                    "https://wa.me/34685572880?text=¡Hola! Me gustaría un presupuesto gratuito para reforma de sillas. ¿Cuál es el mejor horario para conversar?",
                    "_blank"
                  )
                }
              >
              ...
              <Button
                size="lg"
                variant="outline"
                className=" border-2 border-blue-600  bg-blue-600 cursor-pointer  text-white hover:bg-blue-600 hover:text-white px-8 py-3 text-lg font-semibold rounded-lg shadow-lg transform transition-all hover:scale-105"
