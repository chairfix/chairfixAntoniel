...
<section id="servicos" className="py-12 sm:py-16 lg:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 lg:mb-16">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-4 lg:mb-6">Nuestros Servicios</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="text-center group hover:transform hover:scale-105 transition-all duration-300">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-foreground mb-3 lg:mb-4">Reforma de Tapicería</h3>
            ...
            <div className="text-center group hover:transform hover:scale-105 transition-all duration-300">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-foreground mb-3 lg:mb-4">Reparación Hidráulica</h3>
            ...
            <div className="text-center group hover:transform hover:scale-105 transition-all duration-300">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-foreground mb-3 lg:mb-4">Restauración Vintage</h3>
              <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
            ...
            <div className="text-center group hover:transform hover:scale-105 transition-all duration-300">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-foreground mb-3 lg:mb-4">Refuerzo Estructural</h3>
              <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
            ...
            <div className="text-center group hover:transform hover:scale-105 transition-all duration-300">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-foreground mb-3 lg:mb-4">Pintura y Acabado</h3>
              <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
            ...
            <div className="text-center group hover:transform hover:scale-105 transition-all duration-300">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-foreground mb-3 lg:mb-4">Personalización</h3>
              <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
            ...
            <div className="bg-gradient-to-r from-accent/10 to-accent/20 rounded-2xl p-8 max-w-3xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <Button 
                  size="lg" 
                  variant="outline"
                  className=" border-2 border-secondary  text-blue-600 hover:bg-blue-600 hover:text-white px-8 py-3 text-lg font-semibold rounded-lg shadow-lg transform transition-all hover:scale-105"
