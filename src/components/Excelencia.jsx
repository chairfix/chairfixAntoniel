...
function Excelencia() {
  return (
    <section className="bg-gray-50 backdrop-blur-sm py-16">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4">¿Por qué elegir ChairFix?</h2>
          ...
          <Card className="hover:shadow-md transition-shadow">
            <CardHeader>
              <div className="flex items-center space-x-3">
                ...
                <CardTitle>Reparación Especializada</CardTitle>
              </div>
            </CardHeader>
            <CardContent>
              <CardDescription>
          ...
          <Card className="hover:shadow-md transition-shadow">
            <CardHeader>
              <div className="flex items-center space-x-3">
                ...
                <CardTitle>Atención en el Lugar</CardTitle>
              </div>
            </CardHeader>
            <CardContent>
              <CardDescription>
          ...
          <Card className="hover:shadow-md transition-shadow">
            <CardHeader>
              <div className="flex items-center space-x-3">
                ...
                <CardTitle>Agilidad Extrema</CardTitle>
              </div>
            </CardHeader>
            <CardContent>
              <CardDescription>
  ...
  <div className="flex justify-center gap-2">
    ...
    <span>Descuento del 10% en el primer servicio</span>
  </div>
  <div className="flex justify-center gap-2">
    <CircleCheckBig className="h-5 w-5 text-green-600 mt-0.5" />
    ...
    <div className="flex justify-center gap-2">
    <CircleCheckBig className="h-5 w-5 text-green-600 mt-0.5" />
    <span>Historial completo de reparaciones</span>
  </div>
    <div className="flex justify-center gap-2">
    <CircleCheckBig className="h-5 w-5 text-green-600 mt-0.5" />
